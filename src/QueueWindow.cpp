...
QueueWindow::QueueWindow(const wxString &title)
  ...
  // Add header text
  wxStaticText *text =
      new wxStaticText(panel, wxID_ANY, "Moves in queue", wxDefaultPosition,
...
void QueueWindow::addItem(const wxString &id, const wxString &op,
...
void QueueWindow::removeFirstItem() { m_queuelist->DeleteItem(0); }
